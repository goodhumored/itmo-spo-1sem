...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    STR_LITERAL = 259,             /* STR_LITERAL  */
    HEX_LITERAL = 260,             /* HEX_LITERAL  */
    BITS_LITERAL = 261,            /* BITS_LITERAL  */
    DEC_LITERAL = 262,             /* DEC_LITERAL  */
    BOOL_LITERAL = 263,            /* BOOL_LITERAL  */
    CHAR_LITERAL = 264,            /* CHAR_LITERAL  */
    BOOL_TYPE = 265,               /* BOOL_TYPE  */
    BYTE_TYPE = 266,               /* BYTE_TYPE  */
    INT_TYPE = 267,                /* INT_TYPE  */
    UINT_TYPE = 268,               /* UINT_TYPE  */
    LONG_TYPE = 269,               /* LONG_TYPE  */
    ULONG_TYPE = 270,              /* ULONG_TYPE  */
